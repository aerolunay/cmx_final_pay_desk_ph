...
const ViewFinalPayModal = ({ selectedEmployee, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-[1000px] 
          ...
          <div className="overflow-y-auto pr-2 mt-2 scrollbar-thin scrollbar-thumb-gray-400">
            ...
            <div className="flex justify-between w-full py-2">
              ...
              <div className="flex flex-col items-end space-y-3 ml-auto">
                ...
                <div className="flex flex-row gap-3">
                  <button
                    onClick={() => handleDownloadExcel(selectedEmployee.empID, selectedEmployee.Name, setIsDownloading)}
                    className="bg-blue-600 hover:bg-blue-700 text-white text-sm px-4 py-1 rounded no-print"
                  >
                    Generate Data
                  </button>
                  ...
                  <button
                    ...
                    className="bg-green-600 hover:bg-green-700 text-white text-sm px-4 py-1 rounded no-print"
                  >
                    Print
                  </button>
                </div>
            ...
            <div className="border border-black p-2">
              ...
              <div className="grid grid-cols-5 gap-1">
                <div className="col-span-3 font-semibold">Gross Remaining Pay:</div>
                <div className="col-span-2 text-right font-semibold">{formatPhp(selectedEmployee.other_due_to_employee)}</div>
                <div className="col-span-3 font-semibold mt-3">Add: Other Adjustments (Contribution Returns, etc.):</div>
                ...
                <div className="col-span-3 font-bold mt-3">Gross Final Pay:</div>
                <div className="col-span-2 text-right font-bold">{formatPhp(grossFinalPay)}</div>
            
                <div className="col-span-3 font-semibold text-red-700 mt-3">Less: Partial 13th Month Pay:</div>
                ...
                <div className="col-span-3 pl-11 font-semibold text-red-700">Outstanding Company Loans:</div>
                <div className="col-span-2 text-right font-semibold text-red-700">{formatPhp(selectedEmployee.outstanding_company_loans)}</div>
                <div className="col-span-3 pl-11 font-semibold text-red-700">Other Accountabilities:</div>
                <div className="col-span-2 text-right font-semibold text-red-800">{formatPhp(selectedEmployee.other_accountabilities)}</div>

                <div className="col-span-3 font-bold text-gray-900 mt-5">Net Final Pay:</div>
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white px-6 py-4 rounded-lg shadow-lg flex items-center gap-3">
          ...
          <span className="text-gray-700 font-medium">Generating Final Pay Documents...</span>
        </div>
      </div>
    )}
